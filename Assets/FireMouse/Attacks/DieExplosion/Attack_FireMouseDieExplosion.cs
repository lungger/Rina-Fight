...
public class Attack_FireMouseDieExplosion : AttackObject
{
    //自然消失最大時間
    ...
    //擊中消失延遲
    public float hittedDeleteTime = 1.0f;
    ...
    public override void FixedUpdate()
    {
        ...
        else
        {
            ...
            if (hittedTimer >= hittedDeleteTime)
                Destroy(this.gameObject);
        }
    }
    ...
    public void PresetAttack(GameCharatcer user, Vector3 startPosition, GameCharatcer target, List<string> attackTags)
    {
        ...
        Master.transform.localPosition = startPosition;
        //Master.transform.LookAt(target.CenterPosition);
